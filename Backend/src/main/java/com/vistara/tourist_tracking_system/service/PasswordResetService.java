        ...
        return """
                ...
                <head>
                  ...
                  <style>
                    ...
                    .container { max-width:500px; margin:30px auto; background:#ffffff; border-radius:16px; box-shadow:0 10px 25px rgba(0,0,0,0.05); overflow:hidden; }
                    .header { background:linear-gradient(135deg, #1e3c72 0%, #2a5298 100%); padding:24px 20px; text-align:center; color:white; }
                    .header h1 { margin:0; font-size:24px; font-weight:600; }
                    .content { padding:32px 24px; }
                    .greeting { font-size:18px; font-weight:500; color:#1e2a3e; margin-bottom:16px; }
                    .message { color:#334155; line-height:1.5; margin-bottom:24px; }
                    .token-box { background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px; padding:20px; text-align:center; margin-bottom:24px; }
                    .token { font-size:32px; font-weight:700; letter-spacing:4px; color:#1e3c72; font-family:monospace; background:white; display:inline-block; padding:8px 20px; border-radius:8px; border:1px solid #cbd5e1; }
                    .expiry { font-size:14px; color:#64748b; margin-top:12px; }
                    .instruction { background:#eff6ff; border-left:4px solid #3b82f6; padding:12px 16px; font-family:monospace; font-size:14px; color:#1e40af; margin-bottom:24px; border-radius:8px; word-break:break-all; }
                    .footer { border-top:1px solid #e2e8f0; padding:20px 24px; font-size:12px; color:#94a3b8; text-align:center; background:#f9fafb; }
                  </style>
                </head>
                <body>
                  <div class="container">
                    <div class="header"><h1>Vistara</h1><p>Tourist Safety & Tracking System</p></div>
                    <div class="content">
                      <div class="greeting">Hello %s,</div>
                      <div class="message">We received a request to reset your Vistara account password.<br>Use the 6‑digit code below to complete the process.</div>
                      <div class="token-box">
                      ...
                      <div class="message" style="font-size:14px; color:#475569;">If you didn't request this, you can safely ignore this email. Your password will not be changed.</div>
                    </div>
                    <div class="footer">&copy; 2026 Vistara – Keeping parks safe.<br>This is an automated message, please do not reply.</div>
                  </div>
                </body>
                </html>
