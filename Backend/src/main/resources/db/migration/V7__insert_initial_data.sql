...
SELECT
    'admin@vistara.com',
    '$2a$12$nOktnh2V9zu2FVEXFh.P1.fqWWvBdlrQvZ.Dvo1EguYMuDC79TX3G',   -- ← replace with real bcrypt hash at deploy time
...
SELECT
    'ranger@vistara.com',
    '$2a$12$ojab0Cg9CBusDsso6Ez0je4TfhuIKksytT15AMZj4f5tm4CZLr25q',   -- ← replace with real bcrypt hash at deploy time
    'Head Park Ranger',
    '+254711111111',
    'PARK_RANGER',
    TRUE,
